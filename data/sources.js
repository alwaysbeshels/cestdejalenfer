const SOURCE_CATALOG = [
  ...
  { name: "Ville de Mont-Royal - Snapshot statique", url: "data/mont-royal-snapshot.json", dataType: "snapshot" },
  { name: "Ville de Beaconsfield - Snapshot statique", url: "data/beaconsfield-snapshot.json", dataType: "snapshot" },
  { name: "Ville de Montréal - Rues piétonnes et partagées (API)", url: "data/montreal-pedestrian-snapshot.json", dataType: "snapshot" },
