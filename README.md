...
La carte est une application statique: ouvrez `index.html` avec un serveur statique local (par exemple l'extension Live Server de VS Code), puis naviguez vers `http://localhost:5500/index.html`. Elle utilise Leaflet avec le fond OpenStreetMap standard et des données GeoJSON officielles.
