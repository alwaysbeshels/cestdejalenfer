...
window.TRANSLATIONS.en = {
  ...
  "filters.showSources": "Show sources",
  "filters.hideSources": "Hide sources",
  ...
  "filters.impactHelp": "<p><strong>Street closed:</strong> traffic is prohibited.</p><p><strong>Lane affected:</strong> a traffic lane is removed.</p><p><strong>Limited access:</strong> local traffic or a temporary direction.</p><p><strong>Parking:</strong> the street remains open, but parking is removed or prohibited.</p>",
  "filters.impactGroupLabel": "Traffic impact types",
  "filters.critical": "Street closed",
  ...
  ,"faq.q.laval": "Why does Laval work a little differently?"
  ,"faq.a.laval": "Laval publishes restriction details and map lines through a MapServer. The lines are displayed from this official service and recolored according to the map legend. Clicking a line retrieves Laval's published details, such as dates, restriction type, work type and reference."
