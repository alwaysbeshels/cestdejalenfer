...
window.TRANSLATIONS.fr = {
  ...
  "filters.showSources": "Afficher les sources",
  "filters.hideSources": "Masquer les sources",
  ...
  ,"faq.a.seeWork": "Vous pouvez utiliser les filtres et la liste « Entraves actives » dans le menu. Vous pouvez aussi cliquer directement sur une ligne colorée de la carte pour faire apparaître les détails des travaux, leurs dates et les informations publiées."
  ...
  ,"faq.a.arrows": "La flèche indique le sens de la géométrie publiée pour un segment. Elle aide à distinguer les entraves directionnelles lorsque la source fournit une ligne. À faible zoom, certaines flèches sont volontairement masquées pour garder la carte lisible."
  ,"faq.q.freshness": "À quel moment les données sont-elles mises à jour?"
  ,"faq.a.freshness": "Les données de Montréal, Laval, Longueuil et du MTMD sont relues à chaque ouverture ou actualisation de la page. Leur disponibilité et leur fréquence de mise à jour dépendent toutefois de chaque organisme public."
  ,"faq.q.sources": "Quelles sources sont utilisées?"
  ,"faq.a.sources": "La carte combine des flux officiels et des pages publiques de travaux. Le tableau ci-dessous regroupe les sources actuellement utilisées ou consultées, avec un lien direct vers chacune. Il est généré à partir du catalogue partagé de l'application afin que toute nouvelle source ajoutée au catalogue apparaisse aussi ici."
  ...
  ,"faq.q.laval": "Pourquoi Laval se comporte-t-elle un peu différemment?"
  ,"faq.a.laval": "Laval publie les détails des entraves et les lignes de sa carte à partir d'un MapServer. Les lignes sont affichées à partir de ce service officiel et recolorées selon la légende de la carte. Un clic sur une ligne récupère les détails publiés par Laval, comme les dates, le type d'entrave, la nature des travaux et la référence."
  ,"faq.q.coverage": "Les données couvrent-elles toutes les rues?"
  ...
  ,"faq.q.continuous": "Les dates indiquent-elles une fermeture continue?"
  ,"faq.a.continuous": "Pas nécessairement. Une date définit la période où une entrave peut être active. Consultez le détail de l'entrave pour connaître les heures, la direction, les voies touchées, les détours ou les exceptions éventuelles."
