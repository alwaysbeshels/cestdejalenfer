...
window.TRANSLATIONS.fr = {
  ...
  ,"faq.a.snapshotNote": "Les snapshots sont des extractions datées de sources officielles. Ils sont mis à jour très régulièrement, mais ne sont pas des flux en direct: la date de la dernière extraction fait foi pour leur fraîcheur."
  ,"faq.q.snapshots": "Que sont les données snapshot et à quelle fréquence sont-elles mises à jour?"
  ,"faq.a.snapshots": "Les snapshots sont des extractions datées de sources officielles conservées dans des fichiers locaux lorsque leur service ne peut pas être chargé directement par une application statique. Ils servent à garder ces entraves disponibles sur la carte malgré cette limitation technique. Ils sont mis à jour très régulièrement, mais pas automatiquement à chaque ouverture de la carte. La colonne « Type de données » du tableau situé dans la question « Quelles sources sont utilisées? » indique quelles sources sont des snapshots; pour connaître leur fraîcheur, consultez la date de dernière extraction associée au fichier ou à la source officielle."
